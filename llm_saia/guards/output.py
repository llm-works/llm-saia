"""Output guards for validating final LLM responses.

Output guards run after the LLM generates a response and can trigger retries
if the output doesn't meet quality requirements.
"""
